...
class decadal_date(object):
    ...
    def timedelta(self,decade_shift):
            ...
            return decadal_date(newyear, newdecade)
    ...
    def decade2days(self):
        dates=[]
        for n in range(int ((self.lastdate() - self.firstdate()).days+1)):
            dates.append(self.firstdate() + datetime.timedelta(n))
        return dates
    ...
    def today(self):
        ...
        return decadal_date(year, decade)
    ...
    @staticmethod
    def min(date1,date2):
        diff=dateformat.decadal_difference(date1, date2)
        if diff<0:
            return date1
        elif diff>0:
            return date2
    ...
    def decadal_daterange(start_date, end_date):
        dates=[]
        for n in range(int(decadal_date.decadal_difference(end_date, start_date)+1)):
            dates.append(start_date.timedelta(n))
        return dates

if __name__ == '__main__':
    date=decadal_date.today()
    date2=decadal_date(2015, 20)
    n=-20
